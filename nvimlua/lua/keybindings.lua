...
local misc = {
  ...
  { "gnh", [[<cmd>lua vim.diagnostic.goto_next({ severity = vim.diagnostic.severity.HINT })<cr>]] },
  { "gph", [[<cmd>lua vim.diagnostic.goto_prev({ severity = vim.diagnostic.severity.HINT })<cr>]] },
  { "gna", [[<cmd>lua vim.diagnostic.goto_next()<cr>]] },
  { "gpa", [[<cmd>lua vim.diagnostic.goto_prev()<cr>]] },
